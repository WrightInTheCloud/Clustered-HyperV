...
param VirtualMachineSize string = 'Standard_D8s_v6'
...
resource vmExtension 'Microsoft.Compute/virtualMachines/extensions@2024-11-01' = {
  parent: vm
  ...
  properties: {
    ...
    settings: {
      wmfVersion: 'latest'
      configuration: {
        url: 'https://raw.githubusercontent.com/WrightInTheCloud/Clustered-HyperV/main/dsc/DSCInstallWindowsFeatures.zip'
...
resource hostVmSetupExtension 'Microsoft.Compute/virtualMachines/extensions@2024-11-01' = {
  ...
  properties: {
    ...
    settings: {
      fileUris: [
        'https://raw.githubusercontent.com/WrightInTheCloud/Clustered-HyperV/refs/heads/main/HostConfig.ps1'
      ]
